...
export const visualPresets = {
  ...
  'tech-directory': {
    ...
    mood: 'dark, useful, curated directory',
    ...
    shape: 'dark cards, compact grids, sharp information hierarchy',
  },
  'retro-bulletin': {
...
export const visualSystem = {
  ...
  typography: {
    ...
    heroTitle: 'text-5xl font-semibold sm:text-6xl lg:text-7xl',
    sectionTitle: 'text-3xl font-semibold sm:text-4xl',
