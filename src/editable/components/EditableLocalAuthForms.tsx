...
const inputClass = 'h-12 rounded-md border border-white/10 bg-white px-4 text-base font-bold text-[#101827] outline-none transition placeholder:text-slate-500 focus:border-[#00d084]'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-md bg-[#00d084] px-6 text-sm font-black uppercase text-[#07110d] shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
